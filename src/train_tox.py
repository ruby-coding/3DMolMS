...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_data', type=str, default='./data/(1)increase_mitochondrial_dysfunction_etkdgv3_train.pkl',
                        help='path to training data (pkl)')
    parser.add_argument('--test_data', type=str, default='./data/(1)increase_mitochondrial_dysfunction_etkdgv3_test.pkl',
    ...
    if args.debug:
        train_set = MolTox_Dataset(args.train_data)
        _, mol, _, _ = train_set[0]
        print("mol shape:", mol.shape)
        sys.exit(0)
    ...
    plot_filename = os.path.join(plot_dir, '0429_qtof_transfer.png')
